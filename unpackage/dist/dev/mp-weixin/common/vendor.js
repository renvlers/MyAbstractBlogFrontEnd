...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"BLOG","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!******************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/pages.json ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!********************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni.promisify.adaptor.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 75 */
/*!*********************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/node_modules/marked/lib/marked.umd.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
(function (global, factory) {
  ...
  function edit(regex, opt) {
    ...
    var obj = {
      replace: function replace(name, val) {
        val = _typeof(val) === 'object' && 'source' in val ? val.source : val;
    ...
    _createClass(_Tokenizer, [{
      ...
      value: function list(src) {
        ...
        if (cap) {
          ...
          if (list.loose) {
            for (var _i = 0; _i < list.items.length; _i++) {
              list.items[_i].loose = true;
            }
          }
          return list;
        }
      ...
      value: function emStrong(src, maskedSrc) {
        ...
        if (!nextChar || !prevChar || this.rules.inline.punctuation.exec(prevChar)) {
          ...
          while ((match = endReg.exec(maskedSrc)) != null) {
            ...
            var raw = _toConsumableArray(src).slice(0, lLength + match.index + rLength + 1).join('');
  ...
  function mangle(text) {
    ...
    for (var i = 0; i < text.length; i++) {
      var ch = Math.random() > 0.5 ? 'x' + text.charCodeAt(i).toString(16) : text.charCodeAt(i).toString();
      out += '&#' + ch + ';';
    }
    return out;
  }
  ...
  var _Renderer = /*#__PURE__*/function () {
    ...
    _createClass(_Renderer, [{
      ...
      value: function link(href, title, text) {
        var cleanHref = cleanUrl(this.options.sanitize, this.options.baseUrl, href);
        if (cleanHref === null) {
          return text;
        }
        href = cleanHref;
  ...
  var _Parser = /*#__PURE__*/function () {
    function _Parser(options) {
      ...
      _defineProperty(this, "slugger", void 0);
      this.options = options || exports.defaults;
  ...
  _defineProperty(_Hooks, "passThroughHooks", new Set(['preprocess', 'postprocess']));
  ...
  var Marked = /*#__PURE__*/function () {
    function Marked() {
      ...
      _defineProperty(this, "Slugger", _Slugger);
          ...
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            switch (token.type) {
              case 'table':
                {
                  var tableToken = token;
                  var _iterator2 = _createForOfIteratorHelper(tableToken.header),
                    _step2;
                  try {
                  ...
                  var _iterator3 = _createForOfIteratorHelper(tableToken.rows),
                    _step3;
                  try {
              ...
              default:
                {
                  (function () {
                    var _this3$defaults$exten, _this3$defaults$exten2;
                    var genericToken = token;
                    if ((_this3$defaults$exten = _this3.defaults.extensions) !== null && _this3$defaults$exten !== void 0 && (_this3$defaults$exten2 = _this3$defaults$exten.childTokens) !== null && _this3$defaults$exten2 !== void 0 && _this3$defaults$exten2[genericToken.type]) {
                      _this3.defaults.extensions.childTokens[genericToken.type].forEach(function (childTokens) {
                        values = values.concat(_this3.walkTokens(genericToken[childTokens], callback));
                      });
                    } else if (genericToken.tokens) {
                      values = values.concat(_this3.walkTokens(genericToken.tokens, callback));
                    }
                  })();
                }
            }
          ...
          if (pack.renderer) {
            (function () {
              ...
              var _loop = function _loop(prop) {
                var rendererFunc = pack.renderer[prop];
                var rendererKey = prop;
                var prevRenderer = renderer[rendererKey];
          ...
          if (pack.tokenizer) {
            (function () {
              ...
              var _loop2 = function _loop2(prop) {
                var tokenizerFunc = pack.tokenizer[prop];
                var tokenizerKey = prop;
                var prevTokenizer = tokenizer[tokenizerKey];
          ...
          if (pack.hooks) {
            (function () {
              ...
              var _loop3 = function _loop3(prop) {
                var hooksFunc = pack.hooks[prop];
                var hooksKey = prop;
                var prevHook = hooks[hooksKey];
                if (_Hooks.passThroughHooks.has(prop)) {
                  hooks[hooksKey] = function (arg) {
  ...
  function _parseMarkdown2(lexer, parser) {
    ...
    return function (src, optOrCallback, callback) {
      ...
      if (_this5.defaults.async === true && origOpt.async === false) {
        if (!opt.silent) {
...
/* 90 */
/*!*******************************************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni_modules/zero-markdown-view/components/mp-html/parser.js ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 91 */
/*!***************************************************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni_modules/zero-markdown-view/components/mp-html/markdown/index.js ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _marked = _interopRequireDefault(__webpack_require__(/*! ./marked.min */ 92));
/**
...
/* 92 */
/*!********************************************************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni_modules/zero-markdown-view/components/mp-html/markdown/marked.min.js ***!
  \********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 93 */
/*!****************************************************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni_modules/zero-markdown-view/components/mp-html/highlight/index.js ***!
  \****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _prism = _interopRequireDefault(__webpack_require__(/*! ./prism.min */ 94));
var _config = _interopRequireDefault(__webpack_require__(/*! ./config */ 95));
...
/* 94 */
/*!********************************************************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni_modules/zero-markdown-view/components/mp-html/highlight/prism.min.js ***!
  \********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 95 */
/*!*****************************************************************************************************************************!*\
  !*** /Users/renvlers/Documents/HBuilderProjects/BLOG/uni_modules/zero-markdown-view/components/mp-html/highlight/config.js ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
